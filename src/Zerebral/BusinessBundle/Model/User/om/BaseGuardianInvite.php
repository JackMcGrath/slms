...
abstract class BaseGuardianInvite extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Zerebral\\BusinessBundle\\Model\\User\\GuardianInvitePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        GuardianInvitePeer
     */
    ...
    /**
     * The value for the guardian_email field.
     * @var        string
     */
    ...
    /**
     * Initializes internal state of BaseGuardianInvite object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [guardian_email] column value.
     *
     * @return string
     */
     ...
     * @return GuardianInvite The current object (for fluent API support)
     */
    public function setStudentId($v)
    {
        ...
        if ($this->student_id !== $v) {
            $this->student_id = $v;
            $this->modifiedColumns[] = GuardianInvitePeer::STUDENT_ID;
        }
    ...
    /**
     * Set the value of [guardian_email] column.
     *
     * @param string $v new value
     * @return GuardianInvite The current object (for fluent API support)
     */
    public function setGuardianEmail($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->guardian_email !== $v) {
            $this->guardian_email = $v;
            $this->modifiedColumns[] = GuardianInvitePeer::GUARDIAN_EMAIL;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[] = GuardianInvitePeer::CODE;
        }
    ...
    public function setActivated($v)
    {
        ...
        if ($this->activated !== $v) {
            $this->activated = $v;
            $this->modifiedColumns[] = GuardianInvitePeer::ACTIVATED;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->guardian_email = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->code = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->activated = ($row[$startcol + 3] !== null) ? (boolean) $row[$startcol + 3] : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = GuardianInvitePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating GuardianInvite object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = GuardianInvitePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = GuardianInviteQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                GuardianInvitePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(GuardianInvitePeer::STUDENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`student_id`';
        }
        if ($this->isColumnModified(GuardianInvitePeer::GUARDIAN_EMAIL)) {
            $modifiedColumns[':p' . $index++]  = '`guardian_email`';
        }
        if ($this->isColumnModified(GuardianInvitePeer::CODE)) {
            $modifiedColumns[':p' . $index++]  = '`code`';
        }
        if ($this->isColumnModified(GuardianInvitePeer::ACTIVATED)) {
            $modifiedColumns[':p' . $index++]  = '`activated`';
        }

        $sql = sprintf(
            'INSERT INTO `guardian_invites` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`student_id`':
                        ...
                        break;
                    case '`guardian_email`':
                        $stmt->bindValue($identifier, $this->guardian_email, PDO::PARAM_STR);
                        break;
                    case '`code`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = GuardianInvitePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = GuardianInvitePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['GuardianInvite'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['GuardianInvite'][$this->getPrimaryKey()] = true;
        $keys = GuardianInvitePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getStudentId(),
            $keys[1] => $this->getGuardianEmail(),
            $keys[2] => $this->getCode(),
            $keys[3] => $this->getActivated(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setGuardianEmail($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setCode($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setActivated($arr[$keys[3]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GuardianInvitePeer::STUDENT_ID)) $criteria->add(GuardianInvitePeer::STUDENT_ID, $this->student_id);
        if ($this->isColumnModified(GuardianInvitePeer::GUARDIAN_EMAIL)) $criteria->add(GuardianInvitePeer::GUARDIAN_EMAIL, $this->guardian_email);
        if ($this->isColumnModified(GuardianInvitePeer::CODE)) $criteria->add(GuardianInvitePeer::CODE, $this->code);
        if ($this->isColumnModified(GuardianInvitePeer::ACTIVATED)) $criteria->add(GuardianInvitePeer::ACTIVATED, $this->activated);
     ...
     * objects.
     *
     * @param object $copyObj An object of GuardianInvite (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return GuardianInvite Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return GuardianInvitePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new GuardianInvitePeer();
        }
    ...
    {
        return (string) $this->exportTo(GuardianInvitePeer::DEFAULT_STRING_FORMAT);
    }
