...
abstract class BaseGuardian extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Zerebral\\BusinessBundle\\Model\\User\\GuardianPeer';
     ...
     * @return Guardian The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = GuardianPeer::ID;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = GuardianPeer::USER_ID;
        }
    ...
    public function setNotes($v)
    {
        ...
        if ($this->notes !== $v) {
            $this->notes = $v;
            $this->modifiedColumns[] = GuardianPeer::NOTES;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = GuardianPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Guardian object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = GuardianPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = GuardianQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                GuardianPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(GuardianPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(GuardianPeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`user_id`';
        }
        if ($this->isColumnModified(GuardianPeer::NOTES)) {
            $modifiedColumns[':p' . $index++]  = '`notes`';
        }

        $sql = sprintf(
            'INSERT INTO `guardians` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = GuardianPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = GuardianPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Guardian'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Guardian'][$this->getPrimaryKey()] = true;
        $keys = GuardianPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GuardianPeer::ID)) $criteria->add(GuardianPeer::ID, $this->id);
        if ($this->isColumnModified(GuardianPeer::USER_ID)) $criteria->add(GuardianPeer::USER_ID, $this->user_id);
        if ($this->isColumnModified(GuardianPeer::NOTES)) $criteria->add(GuardianPeer::NOTES, $this->notes);
    ...
    {
        $criteria = new Criteria(GuardianPeer::DATABASE_NAME);
        $criteria->add(GuardianPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Guardian (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Guardian Clone of current object.
     * @throws PropelException
     */
     ...
     * If this Guardian is new, it will return
    ...
    public function setStudentGuardians(PropelCollection $studentGuardians, PropelPDO $con = null)
    {
        ...
        foreach ($studentGuardiansToDelete as $studentGuardianRemoved) {
            $studentGuardianRemoved->setGuardian(null);
        }
    ...
    protected function doAddStudentGuardian($studentGuardian)
    {
        ...
        $studentGuardian->setGuardian($this);
    }
    ...
    public function removeStudentGuardian($studentGuardian)
    {
        if ($this->getStudentGuardians()->contains($studentGuardian)) {
            ...
            $studentGuardian->setGuardian(null);
        }
     ...
     * Otherwise if this Guardian is new, it will return
     * an empty collection; or if this Guardian has previously
     * been saved, it will retrieve related StudentGuardians from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Guardian.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|StudentGuardian[] List of StudentGuardian objects
     */
    public function getStudentGuardiansJoinStudent($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = StudentGuardianQuery::create(null, $criteria);
     ...
     *
     * @param  Student $student The StudentGuardian object to relate
     * @return Guardian The current object (for fluent API support)
     */
    ...
    {
        return (string) $this->exportTo(GuardianPeer::DEFAULT_STRING_FORMAT);
    }
