...
use Zerebral\BusinessBundle\Model\User\map\TeacherTableMap;
...
abstract class BaseTeacherPeer
{
    ...
    const OM_CLASS = 'Zerebral\\BusinessBundle\\Model\\User\\Teacher';
    ...
    /**
     * Method to invalidate the instance pool of all tables related to teachers
    ...
    public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(TeacherPeer::USER_ID, UserPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Teacher objects pre-filled with their User objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        TeacherPeer::addSelectColumns($criteria);
        $startcol = TeacherPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Teacher) to $obj2 (User)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        TeacherPeer::addSelectColumns($criteria);
        $startcol2 = TeacherPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Teacher) to the collection in $obj2 (User)
                $obj2->addTeacher($obj1);
...
EventDispatcherProxy::trigger(array('construct','peer.construct'), new PeerEvent('Zerebral\BusinessBundle\Model\User\om\BaseTeacherPeer'));
