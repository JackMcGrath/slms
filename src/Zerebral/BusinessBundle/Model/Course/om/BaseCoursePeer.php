...
abstract class BaseCoursePeer
{
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (CoursePeer::ID, CoursePeer::NAME, CoursePeer::IS_ACTIVE, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (CoursePeer::ID => 0, CoursePeer::NAME => 1, CoursePeer::IS_ACTIVE => 2, ),
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        if ($obj->isNew() || $obj->isColumnModified(CoursePeer::IS_ACTIVE))
            $columns[CoursePeer::IS_ACTIVE] = $obj->getIsActive();
