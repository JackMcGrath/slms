...
abstract class BaseGradeLevelPeer
{
    ...
    const TABLE_NAME = 'grade_levels';

    /** the related Propel class for this table */
    const OM_CLASS = 'Zerebral\\BusinessBundle\\Model\\Course\\GradeLevel';

    /** the related TableMap class for this table */
    const TM_CLASS = 'GradeLevelTableMap';
    ...
    const ID = 'grade_levels.id';

    /** the column name for the name field */
    const NAME = 'grade_levels.name';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identiy map to hold any loaded instances of GradeLevel objects.
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (GradeLevelPeer::ID, GradeLevelPeer::NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (GradeLevelPeer::ID => 0, GradeLevelPeer::NAME => 1, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(GradeLevelPeer::NAME);
        } else {
    ...
    /**
     * Method to invalidate the instance pool of all tables related to grade_levels
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseGradeLevelPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new GradeLevelTableMap());
      }
    }
    ...
    /**
     * Deletes all rows from the grade_levels table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
...
EventDispatcherProxy::trigger(array('construct','peer.construct'), new PeerEvent('Zerebral\BusinessBundle\Model\Course\om\BaseGradeLevelPeer'));
