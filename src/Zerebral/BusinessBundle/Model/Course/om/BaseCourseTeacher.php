...
abstract class BaseCourseTeacher extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Zerebral\\BusinessBundle\\Model\\Course\\CourseTeacherPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CourseTeacherPeer
     */
     ...
     * @return CourseTeacher The current object (for fluent API support)
     */
    public function setCourseId($v)
    {
        ...
        if ($this->course_id !== $v) {
            $this->course_id = $v;
            $this->modifiedColumns[] = CourseTeacherPeer::COURSE_ID;
        }
    ...
    public function setTeacherId($v)
    {
        ...
        if ($this->teacher_id !== $v) {
            $this->teacher_id = $v;
            $this->modifiedColumns[] = CourseTeacherPeer::TEACHER_ID;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = CourseTeacherPeer::CREATED_AT;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = CourseTeacherPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CourseTeacher object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CourseTeacherPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CourseTeacherQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                CourseTeacherPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CourseTeacherPeer::COURSE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`course_id`';
        }
        if ($this->isColumnModified(CourseTeacherPeer::TEACHER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`teacher_id`';
        }
        if ($this->isColumnModified(CourseTeacherPeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`created_at`';
        }

        $sql = sprintf(
            'INSERT INTO `course_teachers` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CourseTeacherPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CourseTeacherPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CourseTeacher'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CourseTeacher'][serialize($this->getPrimaryKey())] = true;
        $keys = CourseTeacherPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CourseTeacherPeer::COURSE_ID)) $criteria->add(CourseTeacherPeer::COURSE_ID, $this->course_id);
        if ($this->isColumnModified(CourseTeacherPeer::TEACHER_ID)) $criteria->add(CourseTeacherPeer::TEACHER_ID, $this->teacher_id);
        if ($this->isColumnModified(CourseTeacherPeer::CREATED_AT)) $criteria->add(CourseTeacherPeer::CREATED_AT, $this->created_at);
    ...
    {
        $criteria = new Criteria(CourseTeacherPeer::DATABASE_NAME);
        $criteria->add(CourseTeacherPeer::COURSE_ID, $this->course_id);
        $criteria->add(CourseTeacherPeer::TEACHER_ID, $this->teacher_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getCourseId()) && (null === $this->getTeacherId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of CourseTeacher (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CourseTeacher Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CourseTeacherPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CourseTeacherPeer();
        }
    ...
    public function getCourse(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCourse === null && ($this->course_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCourse->addCourseTeachers($this);
             */
        }
    ...
    public function getTeacher(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aTeacher === null && ($this->teacher_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aTeacher->addCourseTeachers($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CourseTeacherPeer::DEFAULT_STRING_FORMAT);
    }
