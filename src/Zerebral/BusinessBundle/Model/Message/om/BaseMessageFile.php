...
abstract class BaseMessageFile extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Zerebral\\BusinessBundle\\Model\\Message\\MessageFilePeer';
     ...
     * @return MessageFile The current object (for fluent API support)
     */
    public function setfileId($v)
    {
        ...
        if ($this->file_id !== $v) {
            $this->file_id = $v;
            $this->modifiedColumns[] = MessageFilePeer::FILE_ID;
        }
    ...
    public function setmessageId($v)
    {
        ...
        if ($this->message_id !== $v) {
            $this->message_id = $v;
            $this->modifiedColumns[] = MessageFilePeer::MESSAGE_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = MessageFilePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating MessageFile object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = MessageFilePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = MessageFileQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                MessageFilePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(MessageFilePeer::FILE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`file_id`';
        }
        if ($this->isColumnModified(MessageFilePeer::MESSAGE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`message_id`';
        }

        $sql = sprintf(
            'INSERT INTO `message_files` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = MessageFilePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = MessageFilePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['MessageFile'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['MessageFile'][serialize($this->getPrimaryKey())] = true;
        $keys = MessageFilePeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MessageFilePeer::FILE_ID)) $criteria->add(MessageFilePeer::FILE_ID, $this->file_id);
        if ($this->isColumnModified(MessageFilePeer::MESSAGE_ID)) $criteria->add(MessageFilePeer::MESSAGE_ID, $this->message_id);
    ...
    {
        $criteria = new Criteria(MessageFilePeer::DATABASE_NAME);
        $criteria->add(MessageFilePeer::FILE_ID, $this->file_id);
        $criteria->add(MessageFilePeer::MESSAGE_ID, $this->message_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getfileId()) && (null === $this->getmessageId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of MessageFile (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return MessageFile Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return MessageFilePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new MessageFilePeer();
        }
    ...
    public function getFile(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aFile === null && ($this->file_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aFile->addMessageFiles($this);
             */
        }
    ...
    public function getMessage(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aMessage === null && ($this->message_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aMessage->addMessageFiles($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(MessageFilePeer::DEFAULT_STRING_FORMAT);
    }
