...
abstract class BaseAttendance extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Zerebral\\BusinessBundle\\Model\\Attendance\\AttendancePeer';
     ...
     * @return Attendance The current object (for fluent API support)
     */
    ...
    public function setCourseId($v)
    {
        ...
        if ($this->course_id !== $v) {
            $this->course_id = $v;
            $this->modifiedColumns[] = AttendancePeer::COURSE_ID;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AttendancePeer::DATE;
            }
    ...
    public function setTeacherId($v)
    {
        ...
        if ($this->teacher_id !== $v) {
            $this->teacher_id = $v;
            $this->modifiedColumns[] = AttendancePeer::TEACHER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 4; // 4 = AttendancePeer::NUM_HYDRATE_COLUMNS.
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = AttendancePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = AttendanceQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                AttendancePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AttendancePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(AttendancePeer::COURSE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`course_id`';
        }
        if ($this->isColumnModified(AttendancePeer::DATE)) {
            $modifiedColumns[':p' . $index++]  = '`date`';
        }
        if ($this->isColumnModified(AttendancePeer::TEACHER_ID)) {
    ...
    {
        if (isset($alreadyDumpedObjects['Attendance'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Attendance'][$this->getPrimaryKey()] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AttendancePeer::COURSE_ID)) $criteria->add(AttendancePeer::COURSE_ID, $this->course_id);
        if ($this->isColumnModified(AttendancePeer::DATE)) $criteria->add(AttendancePeer::DATE, $this->date);
        if ($this->isColumnModified(AttendancePeer::TEACHER_ID)) $criteria->add(AttendancePeer::TEACHER_ID, $this->teacher_id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Attendance (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Attendance Clone of current object.
     * @throws PropelException
     */
    ...
    public function getCourse(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCourse === null && ($this->course_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCourse->addAttendances($this);
             */
        }
    ...
    public function getTeacher(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aTeacher === null && ($this->teacher_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aTeacher->addAttendances($this);
             */
        }
     ...
     * If this Attendance is new, it will return
    ...
    public function setStudentAttendances(PropelCollection $studentAttendances, PropelPDO $con = null)
    {
        ...
        foreach ($studentAttendancesToDelete as $studentAttendanceRemoved) {
            $studentAttendanceRemoved->setAttendance(null);
        }
    ...
    {
        return (string) $this->exportTo(AttendancePeer::DEFAULT_STRING_FORMAT);
    }
