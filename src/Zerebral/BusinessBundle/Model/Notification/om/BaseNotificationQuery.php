 ...
 * @method NotificationQuery orderByCourseId($order = Criteria::ASC) Order by the course_id column
 * @method NotificationQuery orderByAssignmentId($order = Criteria::ASC) Order by the assignment_id column
 * @method NotificationQuery orderByType($order = Criteria::ASC) Order by the type column
 * @method NotificationQuery orderByParams($order = Criteria::ASC) Order by the params column
 * @method NotificationQuery orderByIsRead($order = Criteria::ASC) Order by the is_read column
 * @method NotificationQuery orderByCreatedBy($order = Criteria::ASC) Order by the created_by column
 ...
 * @method NotificationQuery groupByCourseId() Group by the course_id column
 * @method NotificationQuery groupByAssignmentId() Group by the assignment_id column
 * @method NotificationQuery groupByType() Group by the type column
 * @method NotificationQuery groupByParams() Group by the params column
 * @method NotificationQuery groupByIsRead() Group by the is_read column
 * @method NotificationQuery groupByCreatedBy() Group by the created_by column
 ...
 *
 * @method NotificationQuery leftJoinAssignment($relationAlias = null) Adds a LEFT JOIN clause to the query using the Assignment relation
 * @method NotificationQuery rightJoinAssignment($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Assignment relation
 * @method NotificationQuery innerJoinAssignment($relationAlias = null) Adds a INNER JOIN clause to the query using the Assignment relation
 *
 * @method NotificationQuery leftJoinCourse($relationAlias = null) Adds a LEFT JOIN clause to the query using the Course relation
 * @method NotificationQuery rightJoinCourse($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Course relation
 * @method NotificationQuery innerJoinCourse($relationAlias = null) Adds a INNER JOIN clause to the query using the Course relation
 *
 * @method NotificationQuery leftJoinUserRelatedByCreatedBy($relationAlias = null) Adds a LEFT JOIN clause to the query using the UserRelatedByCreatedBy relation
 * @method NotificationQuery rightJoinUserRelatedByCreatedBy($relationAlias = null) Adds a RIGHT JOIN clause to the query using the UserRelatedByCreatedBy relation
 * @method NotificationQuery innerJoinUserRelatedByCreatedBy($relationAlias = null) Adds a INNER JOIN clause to the query using the UserRelatedByCreatedBy relation
 *
 * @method NotificationQuery leftJoinUserRelatedByUserId($relationAlias = null) Adds a LEFT JOIN clause to the query using the UserRelatedByUserId relation
 * @method NotificationQuery rightJoinUserRelatedByUserId($relationAlias = null) Adds a RIGHT JOIN clause to the query using the UserRelatedByUserId relation
 * @method NotificationQuery innerJoinUserRelatedByUserId($relationAlias = null) Adds a INNER JOIN clause to the query using the UserRelatedByUserId relation
 *
 ...
 * @method Notification findOneByCourseId(int $course_id) Return the first Notification filtered by the course_id column
 * @method Notification findOneByAssignmentId(int $assignment_id) Return the first Notification filtered by the assignment_id column
 * @method Notification findOneByType(string $type) Return the first Notification filtered by the type column
 * @method Notification findOneByParams(string $params) Return the first Notification filtered by the params column
 * @method Notification findOneByIsRead(boolean $is_read) Return the first Notification filtered by the is_read column
 * @method Notification findOneByCreatedBy(int $created_by) Return the first Notification filtered by the created_by column
 ...
 * @method array findByCourseId(int $course_id) Return Notification objects filtered by the course_id column
 * @method array findByAssignmentId(int $assignment_id) Return Notification objects filtered by the assignment_id column
 * @method array findByType(string $type) Return Notification objects filtered by the type column
 * @method array findByParams(string $params) Return Notification objects filtered by the params column
 * @method array findByIsRead(boolean $is_read) Return Notification objects filtered by the is_read column
 * @method array findByCreatedBy(int $created_by) Return Notification objects filtered by the created_by column
...
abstract class BaseNotificationQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'default', $modelName = 'Zerebral\\BusinessBundle\\Model\\Notification\\Notification', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `user_id`, `course_id`, `assignment_id`, `type`, `params`, `is_read`, `created_by`, `created_at` FROM `notifications` WHERE `id` = :p0';
        try {
    ...
    public function filterByCourseId($courseId = null, $comparison = null)
    {
        if (is_array($courseId)) {
            ...
            if (isset($courseId['min'])) {
                $this->addUsingAlias(NotificationPeer::COURSE_ID, $courseId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($courseId['max'])) {
                $this->addUsingAlias(NotificationPeer::COURSE_ID, $courseId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(NotificationPeer::COURSE_ID, $courseId, $comparison);
    }
    ...
    public function filterByAssignmentId($assignmentId = null, $comparison = null)
    {
        if (is_array($assignmentId)) {
            ...
            if (isset($assignmentId['min'])) {
                $this->addUsingAlias(NotificationPeer::ASSIGNMENT_ID, $assignmentId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($assignmentId['max'])) {
                $this->addUsingAlias(NotificationPeer::ASSIGNMENT_ID, $assignmentId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(NotificationPeer::ASSIGNMENT_ID, $assignmentId, $comparison);
    }
    ...
    public function filterByParams($params = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(NotificationPeer::PARAMS, $params, $comparison);
    }
    ...
    public function filterByIsRead($isRead = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(NotificationPeer::IS_READ, $isRead, $comparison);
    }
    ...
    public function filterByCreatedBy($createdBy = null, $comparison = null)
    {
        if (is_array($createdBy)) {
            ...
            if (isset($createdBy['min'])) {
                $this->addUsingAlias(NotificationPeer::CREATED_BY, $createdBy['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createdBy['max'])) {
                $this->addUsingAlias(NotificationPeer::CREATED_BY, $createdBy['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(NotificationPeer::CREATED_BY, $createdBy, $comparison);
    }
    ...
    public function filterByAssignment($assignment, $comparison = null)
    {
        if ($assignment instanceof Assignment) {
            return $this
                ->addUsingAlias(NotificationPeer::ASSIGNMENT_ID, $assignment->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(NotificationPeer::ASSIGNMENT_ID, $assignment->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByCourse($course, $comparison = null)
    {
        if ($course instanceof Course) {
            return $this
                ->addUsingAlias(NotificationPeer::COURSE_ID, $course->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(NotificationPeer::COURSE_ID, $course->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByUserRelatedByCreatedBy($user, $comparison = null)
    {
        if ($user instanceof User) {
            return $this
                ->addUsingAlias(NotificationPeer::CREATED_BY, $user->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(NotificationPeer::CREATED_BY, $user->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function useUserRelatedByCreatedByQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'UserRelatedByCreatedBy', '\Zerebral\BusinessBundle\Model\User\UserQuery');
    }
