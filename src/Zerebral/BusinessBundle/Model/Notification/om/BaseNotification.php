...
abstract class BaseNotification extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Zerebral\\BusinessBundle\\Model\\Notification\\NotificationPeer';
    ...
    public function setCourseId($v)
    {
        ...
        if ($this->course_id !== $v) {
            $this->course_id = $v;
            $this->modifiedColumns[] = NotificationPeer::COURSE_ID;
        }
    ...
    public function setAssignmentId($v)
    {
        ...
        if ($this->assignment_id !== $v) {
            ...
            $this->modifiedColumns[] = NotificationPeer::ASSIGNMENT_ID;
        }
    ...
    public function setParams($v)
    {
        ...
        if ($this->params !== $v) {
            $this->params = $v;
            $this->modifiedColumns[] = NotificationPeer::PARAMS;
        }
    ...
    public function setIsRead($v)
    {
        ...
        if ($this->is_read !== $v) {
            $this->is_read = $v;
            $this->modifiedColumns[] = NotificationPeer::IS_READ;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->assignment_id = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            $this->type = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->params = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->is_read = ($row[$startcol + 6] !== null) ? (boolean) $row[$startcol + 6] : null;
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(NotificationPeer::COURSE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`course_id`';
        }
        if ($this->isColumnModified(NotificationPeer::ASSIGNMENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`assignment_id`';
        }
        if ($this->isColumnModified(NotificationPeer::TYPE)) {
            $modifiedColumns[':p' . $index++]  = '`type`';
        }
        if ($this->isColumnModified(NotificationPeer::PARAMS)) {
            $modifiedColumns[':p' . $index++]  = '`params`';
        }
        if ($this->isColumnModified(NotificationPeer::IS_READ)) {
            $modifiedColumns[':p' . $index++]  = '`is_read`';
        }
        if ($this->isColumnModified(NotificationPeer::CREATED_BY)) {
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setAssignmentId($arr[$keys[3]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(NotificationPeer::COURSE_ID)) $criteria->add(NotificationPeer::COURSE_ID, $this->course_id);
        if ($this->isColumnModified(NotificationPeer::ASSIGNMENT_ID)) $criteria->add(NotificationPeer::ASSIGNMENT_ID, $this->assignment_id);
        if ($this->isColumnModified(NotificationPeer::TYPE)) $criteria->add(NotificationPeer::TYPE, $this->type);
        if ($this->isColumnModified(NotificationPeer::PARAMS)) $criteria->add(NotificationPeer::PARAMS, $this->params);
        if ($this->isColumnModified(NotificationPeer::IS_READ)) $criteria->add(NotificationPeer::IS_READ, $this->is_read);
    ...
    public function getAssignment(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAssignment === null && ($this->assignment_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aAssignment->addNotifications($this);
             */
        }
    ...
    public function getCourse(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCourse === null && ($this->course_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCourse->addNotifications($this);
             */
        }
    ...
    public function setUserRelatedByCreatedBy(User $v = null)
    {
        ...
        if ($v !== null) {
            $v->addNotificationRelatedByCreatedBy($this);
        }
    ...
    public function getUserRelatedByCreatedBy(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUserRelatedByCreatedBy === null && ($this->created_by !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByCreatedBy->addNotificationsRelatedByCreatedBy($this);
             */
        }
    ...
    public function getUserRelatedByUserId(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUserRelatedByUserId === null && ($this->user_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByUserId->addNotificationsRelatedByUserId($this);
             */
        }
