...
abstract class BaseFileReferences extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Zerebral\\BusinessBundle\\Model\\File\\FileReferencesPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        FileReferencesPeer
     */
    ...
    /**
     * The value for the reference_type field.
     * @var        string
     */
    ...
    /**
     * Get the [reference_type] column value.
     *
     * @return string
     */
    ...
    public function setfileId($v)
    {
        ...
        if ($this->file_id !== $v) {
            $this->file_id = $v;
            $this->modifiedColumns[] = FileReferencesPeer::FILE_ID;
        }
    ...
    /**
     * Set the value of [reference_type] column.
     *
    ...
    public function setreferenceType($v)
    {
        ...
        if ($this->reference_type !== $v) {
            $this->reference_type = $v;
            $this->modifiedColumns[] = FileReferencesPeer::REFERENCE_TYPE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->reference_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->reference_type = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = FileReferencesPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating FileReferences object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = FileReferencesPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = FileReferencesQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                FileReferencesPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->astudentAssignmentReferenceId !== null) {
                if ($this->astudentAssignmentReferenceId->isModified() || $this->astudentAssignmentReferenceId->isNew()) {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(FileReferencesPeer::FILE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`file_id`';
        }
        if ($this->isColumnModified(FileReferencesPeer::REFERENCE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`reference_id`';
        }
        if ($this->isColumnModified(FileReferencesPeer::REFERENCE_TYPE)) {
            $modifiedColumns[':p' . $index++]  = '`reference_type`';
        }

        $sql = sprintf(
            'INSERT INTO `file_references` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`reference_id`':
                        ...
                        break;
                    case '`reference_type`':
                        $stmt->bindValue($identifier, $this->reference_type, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->astudentAssignmentReferenceId !== null) {
                if (!$this->astudentAssignmentReferenceId->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->astudentAssignmentReferenceId->getValidationFailures());
                }
            }
    ...
    {
        $pos = FileReferencesPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['FileReferences'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['FileReferences'][serialize($this->getPrimaryKey())] = true;
        $keys = FileReferencesPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getfileId(),
            $keys[1] => $this->getreferenceId(),
            $keys[2] => $this->getreferenceType(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setreferenceId($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setreferenceType($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FileReferencesPeer::FILE_ID)) $criteria->add(FileReferencesPeer::FILE_ID, $this->file_id);
        if ($this->isColumnModified(FileReferencesPeer::REFERENCE_ID)) $criteria->add(FileReferencesPeer::REFERENCE_ID, $this->reference_id);
        if ($this->isColumnModified(FileReferencesPeer::REFERENCE_TYPE)) $criteria->add(FileReferencesPeer::REFERENCE_TYPE, $this->reference_type);
    ...
    {
        $criteria = new Criteria(FileReferencesPeer::DATABASE_NAME);
        $criteria->add(FileReferencesPeer::FILE_ID, $this->file_id);
        $criteria->add(FileReferencesPeer::REFERENCE_ID, $this->reference_id);
        $criteria->add(FileReferencesPeer::REFERENCE_TYPE, $this->reference_type);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getfileId()) && (null === $this->getreferenceId()) && (null === $this->getreferenceType());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of FileReferences (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return FileReferences Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return FileReferencesPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new FileReferencesPeer();
        }
    ...
    public function getFile(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aFile === null && ($this->file_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aFile->addFileReferencess($this);
             */
        }
     ...
     * @throws PropelException
     */
    public function setstudentAssignmentReferenceId(StudentAssignment $v = null)
    {
        if ($v === null) {
            $this->setreferenceId(NULL);
        } else {
        ...
        $this->astudentAssignmentReferenceId = $v;
     ...
     * @throws PropelException
     */
    public function getstudentAssignmentReferenceId(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->astudentAssignmentReferenceId === null && ($this->reference_id !== null) && $doQuery) {
            $this->astudentAssignmentReferenceId = StudentAssignmentQuery::create()->findPk($this->reference_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->astudentAssignmentReferenceId->addFileReferencess($this);
             */
        }

        return $this->astudentAssignmentReferenceId;
    }
    ...
    {
        return (string) $this->exportTo(FileReferencesPeer::DEFAULT_STRING_FORMAT);
    }
