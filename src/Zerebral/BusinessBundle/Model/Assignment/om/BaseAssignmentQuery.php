 ...
 *
 * @method AssignmentQuery leftJoinAssignmentFile($relationAlias = null) Adds a LEFT JOIN clause to the query using the AssignmentFile relation
 * @method AssignmentQuery rightJoinAssignmentFile($relationAlias = null) Adds a RIGHT JOIN clause to the query using the AssignmentFile relation
 * @method AssignmentQuery innerJoinAssignmentFile($relationAlias = null) Adds a INNER JOIN clause to the query using the AssignmentFile relation
 *
...
abstract class BaseAssignmentQuery extends ModelCriteria
{
    ...
    public function filterByAssignmentFile($assignmentFile, $comparison = null)
    {
        if ($assignmentFile instanceof AssignmentFile) {
            return $this
                ->addUsingAlias(AssignmentPeer::ID, $assignmentFile->getassignmentId(), $comparison);
