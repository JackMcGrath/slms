...
abstract class BaseAssignmentFile extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Zerebral\\BusinessBundle\\Model\\Assignment\\AssignmentFilePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        AssignmentFilePeer
     */
     ...
     * @return AssignmentFile The current object (for fluent API support)
     */
    public function setfileId($v)
    {
        ...
        if ($this->file_id !== $v) {
            $this->file_id = $v;
            $this->modifiedColumns[] = AssignmentFilePeer::FILE_ID;
        }
    ...
    public function setassignmentId($v)
    {
        ...
        if ($this->assignment_id !== $v) {
            ...
            $this->modifiedColumns[] = AssignmentFilePeer::ASSIGNMENT_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = AssignmentFilePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating AssignmentFile object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = AssignmentFilePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = AssignmentFileQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                AssignmentFilePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AssignmentFilePeer::FILE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`file_id`';
        }
        if ($this->isColumnModified(AssignmentFilePeer::ASSIGNMENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`assignment_id`';
        }

        $sql = sprintf(
            'INSERT INTO `assignment_files` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = AssignmentFilePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = AssignmentFilePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['AssignmentFile'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AssignmentFile'][serialize($this->getPrimaryKey())] = true;
        $keys = AssignmentFilePeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AssignmentFilePeer::FILE_ID)) $criteria->add(AssignmentFilePeer::FILE_ID, $this->file_id);
        if ($this->isColumnModified(AssignmentFilePeer::ASSIGNMENT_ID)) $criteria->add(AssignmentFilePeer::ASSIGNMENT_ID, $this->assignment_id);
    ...
    {
        $criteria = new Criteria(AssignmentFilePeer::DATABASE_NAME);
        $criteria->add(AssignmentFilePeer::FILE_ID, $this->file_id);
        $criteria->add(AssignmentFilePeer::ASSIGNMENT_ID, $this->assignment_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getfileId()) && (null === $this->getassignmentId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of AssignmentFile (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return AssignmentFile Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return AssignmentFilePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new AssignmentFilePeer();
        }
    ...
    public function getFile(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aFile === null && ($this->file_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aFile->addAssignmentFiles($this);
             */
        }
    ...
    public function getAssignment(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAssignment === null && ($this->assignment_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAssignment->addAssignmentFiles($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(AssignmentFilePeer::DEFAULT_STRING_FORMAT);
    }
