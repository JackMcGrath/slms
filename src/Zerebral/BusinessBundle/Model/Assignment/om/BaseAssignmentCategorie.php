...
abstract class BaseAssignmentCategorie extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Zerebral\\BusinessBundle\\Model\\Assignment\\AssignmentCategoriePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        AssignmentCategoriePeer
     */
     ...
     * @return AssignmentCategorie The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = AssignmentCategoriePeer::ID;
        }
    ...
    public function setCourseId($v)
    {
        ...
        if ($this->course_id !== $v) {
            $this->course_id = $v;
            $this->modifiedColumns[] = AssignmentCategoriePeer::COURSE_ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = AssignmentCategoriePeer::NAME;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AssignmentCategoriePeer::CREATED_AT;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 4; // 4 = AssignmentCategoriePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating AssignmentCategorie object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = AssignmentCategoriePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = AssignmentCategorieQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                AssignmentCategoriePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AssignmentCategoriePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(AssignmentCategoriePeer::COURSE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`course_id`';
        }
        if ($this->isColumnModified(AssignmentCategoriePeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(AssignmentCategoriePeer::CREATED_AT)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = AssignmentCategoriePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = AssignmentCategoriePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['AssignmentCategorie'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AssignmentCategorie'][$this->getPrimaryKey()] = true;
        $keys = AssignmentCategoriePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AssignmentCategoriePeer::ID)) $criteria->add(AssignmentCategoriePeer::ID, $this->id);
        if ($this->isColumnModified(AssignmentCategoriePeer::COURSE_ID)) $criteria->add(AssignmentCategoriePeer::COURSE_ID, $this->course_id);
        if ($this->isColumnModified(AssignmentCategoriePeer::NAME)) $criteria->add(AssignmentCategoriePeer::NAME, $this->name);
        if ($this->isColumnModified(AssignmentCategoriePeer::CREATED_AT)) $criteria->add(AssignmentCategoriePeer::CREATED_AT, $this->created_at);
    ...
    {
        $criteria = new Criteria(AssignmentCategoriePeer::DATABASE_NAME);
        $criteria->add(AssignmentCategoriePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of AssignmentCategorie (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return AssignmentCategorie Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return AssignmentCategoriePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new AssignmentCategoriePeer();
        }
     ...
     * If this AssignmentCategorie is new, it will return
        ...
        if (null === $this->collAssignments || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collAssignments) {
                ...
                $collAssignments = AssignmentQuery::create(null, $criteria)
                    ->filterByAssignmentCategorie($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setAssignments(PropelCollection $assignments, PropelPDO $con = null)
    {
        ...
        foreach ($this->assignmentsScheduledForDeletion as $assignmentRemoved) {
            $assignmentRemoved->setAssignmentCategorie(null);
        }
    ...
    protected function doAddAssignment($assignment)
    {
        ...
        $assignment->setAssignmentCategorie($this);
    }
    ...
    public function removeAssignment($assignment)
    {
        if ($this->getAssignments()->contains($assignment)) {
            ...
            $assignment->setAssignmentCategorie(null);
        }
     ...
     * Otherwise if this AssignmentCategorie is new, it will return
     * an empty collection; or if this AssignmentCategorie has previously
     * been saved, it will retrieve related Assignments from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in AssignmentCategorie.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(AssignmentCategoriePeer::DEFAULT_STRING_FORMAT);
    }
