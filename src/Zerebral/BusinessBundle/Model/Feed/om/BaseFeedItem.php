...
abstract class BaseFeedItem extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Zerebral\\BusinessBundle\\Model\\Feed\\FeedItemPeer';
     ...
     * @return FeedItem The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = FeedItemPeer::ID;
        }
    ...
    public function setAssignmentId($v)
    {
        ...
        if ($this->assignment_id !== $v) {
            ...
            $this->modifiedColumns[] = FeedItemPeer::ASSIGNMENT_ID;
        }
    ...
    public function setCourseId($v)
    {
        ...
        if ($this->course_id !== $v) {
            $this->course_id = $v;
            $this->modifiedColumns[] = FeedItemPeer::COURSE_ID;
        }
    ...
    public function setFeedContentId($v)
    {
        ...
        if ($this->feed_content_id !== $v) {
            ...
            $this->modifiedColumns[] = FeedItemPeer::FEED_CONTENT_ID;
        }
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[] = FeedItemPeer::CREATED_BY;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = FeedItemPeer::CREATED_AT;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->feed_content_id = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            ...
            return $startcol + 6; // 6 = FeedItemPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating FeedItem object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = FeedItemPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = FeedItemQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                FeedItemPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(FeedItemPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(FeedItemPeer::ASSIGNMENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`assignment_id`';
        }
        if ($this->isColumnModified(FeedItemPeer::COURSE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`course_id`';
        }
        if ($this->isColumnModified(FeedItemPeer::FEED_CONTENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`feed_content_id`';
        }
        if ($this->isColumnModified(FeedItemPeer::CREATED_BY)) {
            $modifiedColumns[':p' . $index++]  = '`created_by`';
        }
        if ($this->isColumnModified(FeedItemPeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`created_at`';
        }

        $sql = sprintf(
            'INSERT INTO `feed_items` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = FeedItemPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = FeedItemPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['FeedItem'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['FeedItem'][$this->getPrimaryKey()] = true;
        $keys = FeedItemPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getAssignmentId(),
            $keys[2] => $this->getCourseId(),
            $keys[3] => $this->getFeedContentId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setFeedContentId($arr[$keys[3]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FeedItemPeer::ID)) $criteria->add(FeedItemPeer::ID, $this->id);
        if ($this->isColumnModified(FeedItemPeer::ASSIGNMENT_ID)) $criteria->add(FeedItemPeer::ASSIGNMENT_ID, $this->assignment_id);
        if ($this->isColumnModified(FeedItemPeer::COURSE_ID)) $criteria->add(FeedItemPeer::COURSE_ID, $this->course_id);
        if ($this->isColumnModified(FeedItemPeer::FEED_CONTENT_ID)) $criteria->add(FeedItemPeer::FEED_CONTENT_ID, $this->feed_content_id);
        if ($this->isColumnModified(FeedItemPeer::CREATED_BY)) $criteria->add(FeedItemPeer::CREATED_BY, $this->created_by);
        if ($this->isColumnModified(FeedItemPeer::CREATED_AT)) $criteria->add(FeedItemPeer::CREATED_AT, $this->created_at);
    ...
    {
        $criteria = new Criteria(FeedItemPeer::DATABASE_NAME);
        $criteria->add(FeedItemPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of FeedItem (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return FeedItem Clone of current object.
     * @throws PropelException
     */
    ...
    public function getFeedContent(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aFeedContent === null && ($this->feed_content_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aFeedContent->addFeedItems($this);
             */
        }
    ...
    public function getAssignment(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAssignment === null && ($this->assignment_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAssignment->addFeedItems($this);
             */
        }
    ...
    public function getCourse(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCourse === null && ($this->course_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCourse->addFeedItems($this);
             */
        }
     ...
     * If this FeedItem is new, it will return
    ...
    public function setFeedComments(PropelCollection $feedComments, PropelPDO $con = null)
    {
        ...
        foreach ($feedCommentsToDelete as $feedCommentRemoved) {
            $feedCommentRemoved->setFeedItem(null);
        }
     ...
     * Otherwise if this FeedItem is new, it will return
     * an empty collection; or if this FeedItem has previously
     * been saved, it will retrieve related FeedComments from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in FeedItem.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(FeedItemPeer::DEFAULT_STRING_FORMAT);
    }
