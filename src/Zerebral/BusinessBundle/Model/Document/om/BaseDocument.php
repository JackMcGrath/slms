...
abstract class BaseDocument extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Zerebral\\BusinessBundle\\Model\\Document\\DocumentPeer';
    ...
    public function setReferenceId($v)
    {
        ...
        if ($this->reference_id !== $v) {
            $this->reference_id = $v;
            $this->modifiedColumns[] = DocumentPeer::REFERENCE_ID;
        }
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[] = DocumentPeer::TYPE;
        }
    ...
    public function setStorage($v)
    {
        ...
        if ($this->storage !== $v) {
            $this->storage = $v;
            $this->modifiedColumns[] = DocumentPeer::STORAGE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->reference_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->type = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->storage = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(DocumentPeer::REFERENCE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`reference_id`';
        }
        if ($this->isColumnModified(DocumentPeer::TYPE)) {
            $modifiedColumns[':p' . $index++]  = '`type`';
        }
        if ($this->isColumnModified(DocumentPeer::STORAGE)) {
            $modifiedColumns[':p' . $index++]  = '`storage`';
        }
        if ($this->isColumnModified(DocumentPeer::PATH)) {
    ...
    {
        if (isset($alreadyDumpedObjects['Document'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Document'][serialize($this->getPrimaryKey())] = true;
        $keys = DocumentPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getReferenceId(),
            $keys[1] => $this->getType(),
            $keys[2] => $this->getStorage(),
            $keys[3] => $this->getPath(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setStorage($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DocumentPeer::REFERENCE_ID)) $criteria->add(DocumentPeer::REFERENCE_ID, $this->reference_id);
        if ($this->isColumnModified(DocumentPeer::TYPE)) $criteria->add(DocumentPeer::TYPE, $this->type);
        if ($this->isColumnModified(DocumentPeer::STORAGE)) $criteria->add(DocumentPeer::STORAGE, $this->storage);
    ...
    {
        $criteria = new Criteria(DocumentPeer::DATABASE_NAME);
        $criteria->add(DocumentPeer::REFERENCE_ID, $this->reference_id);
        $criteria->add(DocumentPeer::TYPE, $this->type);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getReferenceId()) && (null === $this->getType());
    }
