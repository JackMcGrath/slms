...
abstract class BaseCourseMaterial extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Zerebral\\BusinessBundle\\Model\\Material\\CourseMaterialPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CourseMaterialPeer
     */
     ...
     * @return CourseMaterial The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CourseMaterialPeer::ID;
        }
    ...
    public function setCourseId($v)
    {
        ...
        if ($this->course_id !== $v) {
            $this->course_id = $v;
            $this->modifiedColumns[] = CourseMaterialPeer::COURSE_ID;
        }
    ...
    public function setFolderId($v)
    {
        ...
        if ($this->folder_id !== $v) {
            $this->folder_id = $v;
            $this->modifiedColumns[] = CourseMaterialPeer::FOLDER_ID;
        }

        if ($this->aCourseFolder !== null && $this->aCourseFolder->getId() !== $v) {
            $this->aCourseFolder = null;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = CourseMaterialPeer::DESCRIPTION;
        }
    ...
    public function setFileId($v)
    {
        ...
        if ($this->file_id !== $v) {
            $this->file_id = $v;
            $this->modifiedColumns[] = CourseMaterialPeer::FILE_ID;
        }
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[] = CourseMaterialPeer::CREATED_BY;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = CourseMaterialPeer::CREATED_AT;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 7; // 7 = CourseMaterialPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CourseMaterial object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aCourseFolder !== null && $this->folder_id !== $this->aCourseFolder->getId()) {
            $this->aCourseFolder = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CourseMaterialPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CourseMaterialQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                CourseMaterialPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aCourseFolder !== null) {
                if ($this->aCourseFolder->isModified() || $this->aCourseFolder->isNew()) {
                    $affectedRows += $this->aCourseFolder->save($con);
                }
                $this->setCourseFolder($this->aCourseFolder);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CourseMaterialPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CourseMaterialPeer::COURSE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`course_id`';
        }
        if ($this->isColumnModified(CourseMaterialPeer::FOLDER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`folder_id`';
        }
        if ($this->isColumnModified(CourseMaterialPeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(CourseMaterialPeer::FILE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`file_id`';
        }
        if ($this->isColumnModified(CourseMaterialPeer::CREATED_BY)) {
            $modifiedColumns[':p' . $index++]  = '`created_by`';
        }
        if ($this->isColumnModified(CourseMaterialPeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`created_at`';
        }

        $sql = sprintf(
            'INSERT INTO `course_materials` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aCourseFolder !== null) {
                if (!$this->aCourseFolder->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aCourseFolder->getValidationFailures());
                }
            }
            ...
            if (($retval = CourseMaterialPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CourseMaterialPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CourseMaterial'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CourseMaterial'][$this->getPrimaryKey()] = true;
        $keys = CourseMaterialPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aCourseFolder) {
                $result['CourseFolder'] = $this->aCourseFolder->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
            if (null !== $this->aFile) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CourseMaterialPeer::ID)) $criteria->add(CourseMaterialPeer::ID, $this->id);
        if ($this->isColumnModified(CourseMaterialPeer::COURSE_ID)) $criteria->add(CourseMaterialPeer::COURSE_ID, $this->course_id);
        if ($this->isColumnModified(CourseMaterialPeer::FOLDER_ID)) $criteria->add(CourseMaterialPeer::FOLDER_ID, $this->folder_id);
        if ($this->isColumnModified(CourseMaterialPeer::DESCRIPTION)) $criteria->add(CourseMaterialPeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(CourseMaterialPeer::FILE_ID)) $criteria->add(CourseMaterialPeer::FILE_ID, $this->file_id);
        if ($this->isColumnModified(CourseMaterialPeer::CREATED_BY)) $criteria->add(CourseMaterialPeer::CREATED_BY, $this->created_by);
        if ($this->isColumnModified(CourseMaterialPeer::CREATED_AT)) $criteria->add(CourseMaterialPeer::CREATED_AT, $this->created_at);
    ...
    {
        $criteria = new Criteria(CourseMaterialPeer::DATABASE_NAME);
        $criteria->add(CourseMaterialPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CourseMaterial (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CourseMaterial Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CourseMaterialPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CourseMaterialPeer();
        }
    ...
    public function getTeacher(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aTeacher === null && ($this->created_by !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aTeacher->addCourseMaterials($this);
             */
        }
    ...
    public function getCourse(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCourse === null && ($this->course_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCourse->addCourseMaterials($this);
             */
        }
    ...
    /**
     * Declares an association between this object and a CourseFolder object.
     *
     * @param             CourseFolder $v
     * @return CourseMaterial The current object (for fluent API support)
     * @throws PropelException
     */
    public function setCourseFolder(CourseFolder $v = null)
    {
        if ($v === null) {
        ...
        $this->aCourseFolder = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the CourseFolder object, it will not be re-added.
        if ($v !== null) {
            $v->addCourseMaterial($this);
        }
    ...
    /**
     * Get the associated CourseFolder object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return CourseFolder The associated CourseFolder object.
     * @throws PropelException
     */
    public function getCourseFolder(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCourseFolder === null && ($this->folder_id !== null) && $doQuery) {
            $this->aCourseFolder = CourseFolderQuery::create()->findPk($this->folder_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCourseFolder->addCourseMaterials($this);
             */
        }

        return $this->aCourseFolder;
    }
    ...
    public function getFile(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aFile === null && ($this->file_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aFile->addCourseMaterials($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CourseMaterialPeer::DEFAULT_STRING_FORMAT);
    }
