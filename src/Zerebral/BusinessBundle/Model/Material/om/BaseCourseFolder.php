...
abstract class BaseCourseFolder extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Zerebral\\BusinessBundle\\Model\\Material\\CourseFolderPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CourseFolderPeer
     */
     ...
     * @return CourseFolder The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CourseFolderPeer::ID;
        }
    ...
    public function setCourseId($v)
    {
        ...
        if ($this->course_id !== $v) {
            $this->course_id = $v;
            $this->modifiedColumns[] = CourseFolderPeer::COURSE_ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = CourseFolderPeer::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = CourseFolderPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CourseFolder object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CourseFolderPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CourseFolderQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                CourseFolderPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->courseMaterialsScheduledForDeletion !== null) {
                if (!$this->courseMaterialsScheduledForDeletion->isEmpty()) {
                    foreach ($this->courseMaterialsScheduledForDeletion as $courseMaterial) {
                        // need to save related object because we set the relation to null
                        $courseMaterial->save($con);
                    }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CourseFolderPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CourseFolderPeer::COURSE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`course_id`';
        }
        if ($this->isColumnModified(CourseFolderPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }

        $sql = sprintf(
            'INSERT INTO `course_folders` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CourseFolderPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CourseFolderPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CourseFolder'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CourseFolder'][$this->getPrimaryKey()] = true;
        $keys = CourseFolderPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CourseFolderPeer::ID)) $criteria->add(CourseFolderPeer::ID, $this->id);
        if ($this->isColumnModified(CourseFolderPeer::COURSE_ID)) $criteria->add(CourseFolderPeer::COURSE_ID, $this->course_id);
        if ($this->isColumnModified(CourseFolderPeer::NAME)) $criteria->add(CourseFolderPeer::NAME, $this->name);
    ...
    {
        $criteria = new Criteria(CourseFolderPeer::DATABASE_NAME);
        $criteria->add(CourseFolderPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CourseFolder (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CourseFolder Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CourseFolderPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CourseFolderPeer();
        }
    ...
    public function getCourse(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCourse === null && ($this->course_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCourse->addCourseFolders($this);
             */
        }
     ...
     * If this CourseFolder is new, it will return
    ...
    public function setCourseMaterials(PropelCollection $courseMaterials, PropelPDO $con = null)
    {
        ...
        foreach ($courseMaterialsToDelete as $courseMaterialRemoved) {
            $courseMaterialRemoved->setCourseFolder(null);
        }
    ...
    protected function doAddCourseMaterial($courseMaterial)
    {
        ...
        $courseMaterial->setCourseFolder($this);
    }
    ...
    public function removeCourseMaterial($courseMaterial)
    {
        if ($this->getCourseMaterials()->contains($courseMaterial)) {
            ...
            $this->courseMaterialsScheduledForDeletion[]= $courseMaterial;
            $courseMaterial->setCourseFolder(null);
        }
     ...
     * Otherwise if this CourseFolder is new, it will return
     * an empty collection; or if this CourseFolder has previously
     * been saved, it will retrieve related CourseMaterials from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in CourseFolder.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(CourseFolderPeer::DEFAULT_STRING_FORMAT);
    }
